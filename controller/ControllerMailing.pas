...
Type
  ...
  public
    ...
    procedure getbyKind(tbEntityId:String;Kind:String);
...
procedure TControllerMailing.getbyKind(tbEntityId:String;Kind:String);
Var
  Lc_Qry : TFDQuery;
begin
  Lc_Qry := createQuery;
...
begin
  ...
  try
    ...
    Lc_Qry.ParamByName('entity_id').AsString := Registro.Codigo;
    ...
    while not Lc_Qry.eof do Begin
      ...
      with LITem do
      Begin
        Codigo := Lc_Qry.FieldByName('id').AsString;
