...
Uses
  Rtti, CAtribEntity,  FireDAC.Comp.Client, System.Classes, System.SysUtils,
  System.StrUtils ;
...
class function TGenericOrm._getNextByField<T>(Obj: T; Field: String;Intitution: String): String;
var
  strSelect: String;
begin
  strSelect := concat(
