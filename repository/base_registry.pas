...
begin
  ...
  SB_Alterar.Enabled := ( EditionState = 'B' ) and ( CodigoRegistro <> '' ) and Pf_Alterar;
  SB_Excluir.Enabled := ( EditionState = 'B' ) and ( CodigoRegistro <> '' ) and Pf_Excluir;
...
begin
  ...
  GbInstitution.User.Parametro.TipoPrivilegio   := 'ALTERAR';
  Pf_Alterar    := GbInstitution.User.getPrivilege;
  GbInstitution.User.Parametro.TipoPrivilegio   := 'EXCLUIR';
  Pf_Excluir    := GbInstitution.User.getPrivilege;
end;
